...
if loss_type == 2:
    smoothed_H0t = UnivariateSpline(failure_time, tie_counts / cumulative_sum, s=0.055)
...
plt.scatter(failure_time, tie_counts / cumulative_sum, color='red', alpha=0.6, label='Original Data Points')
