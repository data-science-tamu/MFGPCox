...
if loss_type == 1:
    smoothed_H0t = UnivariateSpline(failure_time, tie_counts / cumulative_sum, s=0.5)

if loss_type == 2:
    smoothed_H0t = UnivariateSpline(failure_time, tie_counts / cumulative_sum, s=0.12)
