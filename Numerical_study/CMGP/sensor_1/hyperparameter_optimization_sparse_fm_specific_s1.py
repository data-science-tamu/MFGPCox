...
from utils.utils_distinct_gp_per_fm.plot_save_print_fm import *
from utils.utils_distinct_gp_per_fm.data_processing_fm import *
from utils.utils_distinct_gp_per_fm.CMGP_fm import *
...
def closure():
    ...
    hyperparameters, lambda_hyp = reconstruct_hyperparameters(
        flat_parameters_initial, initial_hyperparameters, failure_modes
    )
...
file_name = "optimized_hyperparameters_fm_specific"
