...
for key in loaded_hyperparameters:
    if 61 <= key[0] <= 120 and key[1] == 'sensor 1':
        loaded_hyperparameters[key]['xi'] = torch.tensor([2.12], device=device)
...
file_name = "optimized_hyperparameters_unit_specific_xi"
